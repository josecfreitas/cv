...
const CvProjects = () => (
	<>
		...
		<ul className="list-unstyled">
			<CvLiWithLink title="USA's utility automation">
			...
			>
				Concepting, developing and maintaining the brazil's largest
				online farm catalog, which receives over a thousand daily
			...
			<CvLiWithLink title="Linharia" link="http://linharia.com.br">
			...
			<CvLiWithLink title="MeuGuiaCarro" link="https://meuguiacarro.app">
			...
			<CvLiWithLink title="SelectGás" link="https://selectgas.com.br">
			...
			<CvLiWithLink title="EasyProtect">
			...
			<CvLiWithLink title="FlixImóveis">
				Concepting, developing and maintaining an online house and
				apartments catalog. Worked with Java8, Spring Boot,
				Hibernate/JPA, PostgreSQL, Thymeleaf, HTML, CSS, JavaScript,
				jQuery and Bootstrap.
			</CvLiWithLink>
			<CvLiWithLink title="Gamelive">
			...
			<CvLiWithLink title="ÁreaBim" link="https://areabim.com.br/">
			...
			<CvLiWithLink title="Portal GBD" link="https://www.grupogbd.com">
